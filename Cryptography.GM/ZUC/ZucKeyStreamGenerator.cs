...
{
    private static readonly ImmutableArray<byte> S0 = ImmutableArray.Create<byte>(
    ...
    private static readonly ImmutableArray<byte> S1 = ImmutableArray.Create<byte>(
        /*         x0    x1    x2    x3    x4    x5    x6    x7    x8    x9    xA    xB    xC    xD    xE    xF */
    ...
    private static readonly ImmutableArray<ushort> EKd = ImmutableArray.Create<ushort>(
        0x44D7, 0x26BC, 0x626B, 0x135E, 0x5789, 0x35E2, 0x7135, 0x09AF,
        0x4D78, 0x2F13, 0x6BC4, 0x1AF1, 0x5E26, 0x3C4D, 0x789A, 0x47AC
    );

    private static readonly ImmutableArray<byte> EKd256E = ImmutableArray.Create<byte>(
    ...
    private static readonly ImmutableArray<byte> EKd256M32 = ImmutableArray.Create<byte>(
        0b0100010, 0b0101111, 0b0100101, 0b0101010, 0b1101101, 0b1000000, 0b1000000, 0b1000000,
        0b1000000, 0b1000000, 0b1000000, 0b1000000, 0b1000000, 0b1010010, 0b0010000, 0b0110000
    );

    private static readonly ImmutableArray<byte> EKd256M64 = ImmutableArray.Create<byte>(
        0b0100011, 0b0101111, 0b0100100, 0b0101010, 0b1101101, 0b1000000, 0b1000000, 0b1000000,
        0b1000000, 0b1000000, 0b1000000, 0b1000000, 0b1000000, 0b1010010, 0b0010000, 0b0110000
    );

    private static readonly ImmutableArray<byte> EKd256M128 = ImmutableArray.Create<byte>(
